...
class Eps(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "country_code", "bic", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "country_code", "bic", ], str]):
