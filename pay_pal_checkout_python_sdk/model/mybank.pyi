...
class Mybank(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "country_code", "bic", "iban_last_chars", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "country_code", "bic", "iban_last_chars", ], str]):
