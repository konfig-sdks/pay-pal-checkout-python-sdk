                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "Specified tracker ID does not exist. Check the tracker ID and try again.": "SPECIFIED_TRACKER_ID_DOES_NOT_EXIST__CHECK_THE_TRACKER_ID_AND_TRY_AGAIN_",
                                                }
                                            
                                            @schemas.classproperty
                                            def SPECIFIED_TRACKER_ID_DOES_NOT_EXIST__CHECK_THE_TRACKER_ID_AND_TRY_AGAIN_(cls):
                                                return cls("Specified tracker ID does not exist. Check the tracker ID and try again.")
                                        ...
                                        class issue(
                                            ...
                                            @schemas.classproperty
                                            def TRACKER_ID_NOT_FOUND(cls):
                                                return cls("TRACKER_ID_NOT_FOUND")
                                        __annotations__ = {
