                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "Path should be a valid [JSON Pointer](https://tools.ietf.org/html/rfc6901) that references a location within the request where the operation is performed.": "PATH_SHOULD_BE_A_VALID_JSON_POINTERHTTPS__TOOLS_IETF_ORG_HTML_RFC6901_THAT_REFERENCES_A_LOCATION_WITHIN_THE_REQUEST_WHERE_THE_OPERATION_IS_PERFORMED_",
                                                }
                                            
                                            @schemas.classproperty
                                            def PATH_SHOULD_BE_A_VALID_JSON_POINTERHTTPS__TOOLS_IETF_ORG_HTML_RFC6901_THAT_REFERENCES_A_LOCATION_WITHIN_THE_REQUEST_WHERE_THE_OPERATION_IS_PERFORMED_(cls):
                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "Specify a `value` for the field being patched.": "SPECIFY_A_VALUE_FOR_THE_FIELD_BEING_PATCHED_",
                                                }
                                            
                                            @schemas.classproperty
                                            def SPECIFY_A_VALUE_FOR_THE_FIELD_BEING_PATCHED_(cls):
                                                return cls("Specify a `value` for the field being patched.")
                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "Specify a `value` for the field in which the operation needs to be performed.": "SPECIFY_A_VALUE_FOR_THE_FIELD_IN_WHICH_THE_OPERATION_NEEDS_TO_BE_PERFORMED_",
                                                }
                                            
                                            @schemas.classproperty
                                            def SPECIFY_A_VALUE_FOR_THE_FIELD_IN_WHICH_THE_OPERATION_NEEDS_TO_BE_PERFORMED_(cls):
                                                return cls("Specify a `value` for the field in which the operation needs to be performed.")
