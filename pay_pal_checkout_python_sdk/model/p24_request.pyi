...
class P24Request(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "email", "country_code", "experience_context", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["email"]) -> 'EmailAddress': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "email", "country_code", "experience_context", ], str]):
