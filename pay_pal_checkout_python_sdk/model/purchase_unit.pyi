...
class PurchaseUnit(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def shipping() -> typing.Type['ShippingWithTrackingDetails']:
            ...
            @staticmethod
            def payments() -> typing.Type['PaymentCollection']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["shipping"]) -> 'ShippingWithTrackingDetails': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["supplementary_data"]) -> 'SupplementaryData': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["payments"]) -> 'PaymentCollection': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "reference_id", "amount", "payee", "payment_instruction", "custom_id", "invoice_id", "id", "soft_descriptor", "items", "shipping", "supplementary_data", "payments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["amount"]) -> typing.Union['AmountWithBreakdown', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["shipping"]) -> typing.Union['ShippingWithTrackingDetails', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["supplementary_data"]) -> typing.Union['SupplementaryData', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payments"]) -> typing.Union['PaymentCollection', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "reference_id", "amount", "payee", "payment_instruction", "custom_id", "invoice_id", "id", "soft_descriptor", "items", "shipping", "supplementary_data", "payments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        amount: typing.Union['AmountWithBreakdown', schemas.Unset] = schemas.unset,
        ...
        shipping: typing.Union['ShippingWithTrackingDetails', schemas.Unset] = schemas.unset,
        supplementary_data: typing.Union['SupplementaryData', schemas.Unset] = schemas.unset,
        payments: typing.Union['PaymentCollection', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
