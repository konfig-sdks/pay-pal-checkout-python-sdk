...
class VaultVenmoWalletBase(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "usage_pattern", "usage_type", "customer_type", "permit_multiple_payment_tokens", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "usage_pattern", "usage_type", "customer_type", "permit_multiple_payment_tokens", ], str]):
