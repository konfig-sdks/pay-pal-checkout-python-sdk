...
class VenmoWalletAttributes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def vault() -> typing.Type['VaultVenmoWalletBase']:
                return VaultVenmoWalletBase
            __annotations__ = {
                "customer": customer,
                "vault": vault,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["vault"]) -> 'VaultVenmoWalletBase': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["vault"]) -> typing.Union['VaultVenmoWalletBase', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        vault: typing.Union['VaultVenmoWalletBase', schemas.Unset] = schemas.unset,
