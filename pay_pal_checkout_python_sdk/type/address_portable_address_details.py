...
class RequiredAddressPortableAddressDetails(TypedDict):
    pass

class OptionalAddressPortableAddressDetails(TypedDict, total=False):
    # The street number.
    street_number: str
...
class AddressPortableAddressDetails(RequiredAddressPortableAddressDetails, OptionalAddressPortableAddressDetails):
    pass
