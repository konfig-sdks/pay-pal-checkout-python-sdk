...
class RequiredGiropayRequest(TypedDict):
    name: FullName

    country_code: CountryCode

class OptionalGiropayRequest(TypedDict, total=False):
    experience_context: ExperienceContextBase

class GiropayRequest(RequiredGiropayRequest, OptionalGiropayRequest):
    pass
